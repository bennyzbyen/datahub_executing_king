...
class DataStorage:
    ...
    def upload_channel_data(self, df_store_assess_channel:pd.DataFrame):
        ...
        store_assess_channel_file_path = "cal_b5_store_assess_channel.csv"
    ...
    def run(self):
        ...
        if df_details is not None:
            self._upload_2_clickhouse(df_details, file_path=detail_file_path, clickhouse_table="store_b5_sku_details")
        if df_summary is not None:
            self._upload_2_clickhouse(df_summary, file_path=summary_file_path, clickhouse_table="store_b5_sku_summary")
        if df_ttl is not None:
            self._upload_2_clickhouse(df_ttl, file_path=ttl_file_path, clickhouse_table="store_b5_sku_ttl")
