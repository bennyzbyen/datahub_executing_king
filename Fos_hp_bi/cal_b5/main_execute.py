...
class CAL_B5(object):
    ...
    def __get_execute_range(self) -> dict:
        ...
        logger.info(f"""current_date: {current_date}, yester_day: {yester_day},currentday:{currentday},\n 
                    yesterday: {yesterday}, period: {p}, week:{week}, r6p: {r6p_list}, r3p:{r3p_list}, ytd:{ytd_list}, \n
        ...
        time_range = {"period": p, "week":week, "current_date": current_date, "yester_day": yester_day, 
                    "currentday": currentday, "yesterday": yesterday, "r6p": r6p_list, "r3p": r3p_list,"ytd": ytd_list, 
                    "bysku2025_period": bysku2025_period, "bysku2024_period": bysku2024_period}
        
        # current_date: 2025-05-08, yester_day: 2025-05-07,currentday:20250508, 
        #         yesterday: 20250507, period: 2025P05, week:2025P05W3, r6p: ['2025P02', '2025P03', '2025P04', '2025P05'], r3p: ['2025P03', '2025P04', '2025P05'], ytd:['2025P01', '2025P02', '2025P03', '2025P04', '2025P05'],
